...
<template>
  <section class="flex flex-col h-auto h-screen text-center items-center justify-center">
    <LogoComponent/>
    <div v-if="status=='checking'" role="status" class="mt-4">
      <svg aria-hidden="true" class="w-8 h-8 tg-text animate-spin fill-blue-600"
