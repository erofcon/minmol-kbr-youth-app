...
class Center(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    name = models.CharField(max_length=255, unique=True, verbose_name="Название")
    district = models.ForeignKey(District, on_delete=models.CASCADE, related_name='center', verbose_name="Район")
    emblem = models.ImageField(upload_to='centers/emblems/', blank=True, null=True, verbose_name="Иконка")
